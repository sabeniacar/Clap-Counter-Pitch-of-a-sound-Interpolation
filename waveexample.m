...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
z = resample(y,2,1) ;               %2 times the original sample rate
sound(z, Fs);                          
duration = numel(y) / Fs/(2.0);
pause(duration + 12)                                      
...
sound(y, Fs/(2.0));                             % Play the sound & wait until it finishes

duration = numel(y) / (Fs/(2.0));               % Calculate the duration
pause(duration + 2)                             % Wait that much + 2 seconds
